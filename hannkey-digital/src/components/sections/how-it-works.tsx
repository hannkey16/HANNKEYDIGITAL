              ...
              return (
                <li key={step.step} className="relative">
                  <motion.div
                    ...
                    transition={{ duration: 0.65, delay: 0.25 + index * 0.28, ease: [0.22, 1, 0.36, 1] }}
                    className="flex flex-col items-center text-center"
                  >
                    <span className="relative grid size-[76px] place-items-center rounded-3xl border border-white/10 bg-[#0b1124]">
                      <span aria-hidden="true" className="absolute inset-0 rounded-3xl bg-brand/15 blur-md" />
                      <span className="relative grid size-full place-items-center rounded-3xl">
