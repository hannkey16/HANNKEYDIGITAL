            ...
            return (
              <RevealChild key={benefit.title}>
                ...
                >
                  ...
                  <h3 className="relative mt-5 text-base font-semibold">{benefit.title}</h3>
                  <p className="relative mt-2 text-sm leading-relaxed text-muted-foreground">{benefit.description}</p>
                </motion.div>
              </RevealChild>
            )
          })}
