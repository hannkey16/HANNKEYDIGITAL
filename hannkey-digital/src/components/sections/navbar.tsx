      ...
      >
        ...
        >
                                ...
                                >
                                  ...
                                  >
                                    <img
                                      ...
                                      alt=""
                                      className={cn(
                                        'h-5 w-auto max-w-[65%] object-contain',
                                  ...
                                  <span className="min-w-0">
                                    ...
                                    <span className="block truncate text-xs text-muted-foreground">{formatRupiah(product.price)}</span>
                                  </span>
                                </a>
                              </li>
                            ))}
          ...
          <div className="hidden items-center gap-2 lg:flex">
            <a
              href="#beranda"
              className="inline-flex h-9 items-center rounded-xl border border-white/12 bg-white/5 px-4 text-sm font-medium transition-colors hover:bg-white/10"
            >
              Masuk
            </a>
            <a
              href="#produk"
              className="inline-flex h-9 items-center rounded-xl bg-brand-gradient px-4 text-sm font-semibold text-white"
            >
              Daftar
            </a>
          </div>
          ...
          <div className="flex items-center gap-2 lg:hidden">
            <button
              ...
              aria-expanded={open}
              className="grid size-10 place-items-center rounded-xl border border-white/10 bg-white/5 text-muted-foreground transition-colors hover:text-foreground"
            >
