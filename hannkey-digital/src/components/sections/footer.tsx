      ...
      <div className="mx-auto w-full max-w-[1400px] px-4 py-14 sm:px-6 lg:px-10">
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1.4fr)_minmax(0,0.8fr)_minmax(0,0.8fr)_minmax(0,1.2fr)]">
          <div>
            ...
            <p className="mt-4 max-w-sm text-sm leading-relaxed text-muted-foreground">
              ...
              Aktivasi instan, pembayaran aman, garansi 30 hari, dan harga terbaik setiap hari.
            </p>
          ...
          <nav aria-labelledby="footer-nav">
            <h2 id="footer-nav" className="text-sm font-semibold">Navigasi</h2>
          ...
          <nav aria-labelledby="footer-support">
            <h2 id="footer-support" className="text-sm font-semibold">Bantuan</h2>
            <ul className="mt-4 flex flex-col gap-2.5">
                ...
                >
                  {method.kind === 'svg' ? (
                    <img
                      ...
                      height={20}
                      loading="lazy"
                      className={cn('h-4 w-auto object-contain', method.white && 'logo-white')}
                    />
                  ) : (
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-3 border-t border-white/8 pt-6 sm:flex-row">
          <p className="text-xs text-muted-foreground">
            ...
            <span className="text-gradient font-medium">HannKey Digital</span>. Seluruh hak cipta dilindungi.
          </p>
